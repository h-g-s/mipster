...
enum CBC_Message {
  ...
  CBC_ROOT_DETAIL,
  CBC_ROOT_PASS_CUTS,
  CBC_MIPSTART_WARNING,
  CBC_MIPSTART_INVALID_VALUE,
  CBC_MIPSTART_INVALID_COLUMN,
  CBC_MIPSTART_OUT_OF_BOUNDS,
  CBC_MIPSTART_NON_INTEGRAL,
  CBC_MIPSTART_UNKNOWN_COLUMN,
